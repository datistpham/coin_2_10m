...
function CapitalManagementSetting({ isEdit, setValue, watch }) {
  ...
  const handleOnChangeCapitalManagement = (e) => {
    ...
    setValue(
      "capital_management",
      CAPITALS_TYPE.find((a) => a.value === e.target.value).defaultValue
    );
    ...
    <Grid container spacing={3} sx={{ mt: 3, mb: 3 }}>
      ...
      <Grid item xs={12} md={12}>
        <RHFTextField
          name="bet_second"
          type={"number"}
          label={translate("betting_seconds")}
          size="small"
        />
      </Grid>
      <Grid item xs={6} md={6}>
      ...
      <Grid item xs={6} md={6}>
        <RHFTextField
          name="win_streak_target"
          type={"number"}
          label={translate("win_streak_target")}
          size="small"
        />
      </Grid>
      <Grid item xs={6} md={6}>
        <RHFTextField
          name="lose_streak_target"
          type={"number"}
          label={translate("lose_streak_target")}
          size="small"
        />
      </Grid>
      <Grid item xs={6} md={6}>
        <RHFTextField
          name="win_total_target"
          type={"number"}
          label={translate("win_total_target")}
          size="small"
        />
      </Grid>
      <Grid item xs={6} md={6}>
        <RHFTextField
          name="lose_total_target"
          type={"number"}
          label={translate("lose_total_target")}
          size="small"
        />
      </Grid>
      <Grid
        item
        xs={values.child_profit ? 4 : 12}
        md={values.child_profit ? 4 : 12}
      >
      ...
      <Grid
        item
        xs={values.child_loss ? 4 : 12}
        md={values.child_loss ? 4 : 12}
      >
      ...
      {values.child_loss && (
        <Grid item xs={8} md={8}>
          <RHFTextField
            name="child_loss_amount"
            type={"text"}
            label={translate("child_loss_target")}
            size="small"
          />
        </Grid>
      )}
