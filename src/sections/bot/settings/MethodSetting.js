...
function MethodSetting({ isEdit, setValue, watch }) {
  ...
  return (
    <>
      ...
      />
      {values.fromId ? (
        <Grid container spacing={3} sx={{ mt: 3, mb: 3 }} textCenter>
          ...
          <Grid item xs={12} md={12}>
            <Typography sx={{ color: "info.main" }}>
              {translate("click_edit_configuration_to_finish")}
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={12}>
            <Stack direction="row">
              <RHFCheckbox
                ...
                label={
                  canUseTelegram
                    ? `${translate("send_signal_to_telegram")} (HSD : ${format(
                        new Date(expTelegram),
                        "HH:mm dd/MM"
                      )})`
          ...
          {values.telegram_signal && (
            <Grid item xs={12} md={12}>
              <Stack direction="row" spacing={2}>
                <RHFTextField
                  name="telegram_signal_chatid"
                  type={"text"}
                  label={translate("Chat ID")}
                  size="small"
                />
                <Button
