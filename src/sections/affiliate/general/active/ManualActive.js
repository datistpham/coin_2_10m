...
import { MenuItem, Stack, Alert, Grid } from "@mui/material";
...
export default function ManualActive() {
  ...
  const NetworkSchema = Yup.object().shape({
    ...
    activeType: Yup.string().required(
      translate("please_select_an_active_account_type")
    ),
    nickName: Yup.string().required(
      translate("please_enter_the_nickname_you_want_to_active")
    ),
  });
        ...
        <Grid item xs={12} md={12}>
          ...
          {currentRank > 0 ? (
            ...
            <Alert variant="outlined" severity="warning">
              {translate(
                linkAccountId === 0
                  ? "please_choose_a_trading_account"
