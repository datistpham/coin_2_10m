    ...
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
      ...
      <Grid className={"tag-x-1"} container>
              ...
              <WidgetStatic
                ...
                total={
                  isLoading ? (
                    ...
                    <WinLoseStatic
                      winTotal={statics.winDay}
                      loseTotal={statics.loseDay}
                    />
                  )
                }
                color="error"
        ...
        <Grid item xs={12} md={12} marginTop={2}>
          <CalendarMonth
            linkAccountId={linkAccountId}
            accType={getValues("accountType").toUpperCase()}
          />
        </Grid>
            ...
            <WidgetTotalTarget
              ...
              total={
                isLoading ? (
                  ...
                  `${parseFloat(statics.totalProfit.toFixed(2))} $`
                )
              }
              actions={
                <IconButton
